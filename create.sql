...
create table `user` (is_enabled bit not null, created_at datetime(6), date_of_birth datetime(6), id bigint not null auto_increment, team_id bigint, updated_at datetime(6), city varchar(255), email varchar(255) not null, first_name varchar(255) not null, image_url varchar(255), last_name varchar(255) not null, password varchar(255) not null, role varchar(255), primary key (id)) engine=InnoDB;
create table `user_sport` (id bigint not null auto_increment, sport_id bigint not null, user_id bigint not null, primary key (id)) engine=InnoDB;
...
alter table `user_sport` add constraint FK3pl8bb6t69ccc7uy35tyfm6ja foreign key (sport_id) references sport (id);
alter table `user_sport` add constraint FKnu2llsuljjgs4y3a2l2dqn7mh foreign key (user_id) references `user` (id);
